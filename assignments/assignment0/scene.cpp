...
Scene::Scene()
{
    ...
    water = std::make_unique<ew::Shader>("assets/shaders/default.vs", "assets/shaders/blinnphong.fs");
    //load texture
    texture = std::make_unique<ew::Texture>("assets/textures/Tiles138_1K-JPG_Color.jpg");
